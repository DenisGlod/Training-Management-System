...
public class AdminController extends HttpServlet {
	...
	private void actions(HttpServletRequest request, HttpServletResponse response, String key, String data) throws IOException {
		HttpSession session = request.getSession();
		...
		case SAVE_USER:
			...
			if (StringUtils.isNoneBlank(userBean.getLogin(), userBean.getPassword(), userBean.getRole(), userBean.getLastName(), userBean.getFirstName(), userBean.getMiddleName())) {
		...
		case SAVE_COURSE:
			...
			if (StringUtils.isNoneBlank(coursesBean.getCourseName(), coursesBean.getDescription(), coursesBean.getStatusCourse())) {
		...
		case SAVE_GROUP:
			...
			if (groupBeanSG.getIdTeacher() != null && groupBeanSG.getIdCourse() != null && groupBeanSG.getStatusGroup() != null) {
		...
		case UPDATE_USER:
			...
			if (StringUtils.isNoneBlank(updateUserBean.getLogin(), updateUserBean.getPassword(), updateUserBean.getRole(), updateUserBean.getLastName(), updateUserBean.getFirstName(),
		...
		case UPDATE_COURSE:
			...
			if (StringUtils.isNoneBlank(updateCoursesBean.getCourseName(), updateCoursesBean.getDescription(), updateCoursesBean.getStatusCourse())) {
